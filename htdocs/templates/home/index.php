<?php
$usr=new UserSession(Session::get('session_token'));
		...
		<div class="app-content pt-3 p-md-3 p-lg-4">
			<div class="container-xl">
				...
				<div class="card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
					<div class="inner">
						<div class="card-body p-3 p-lg-4 shadow-sm mb-4 app-bg-success">
							<h3 class="mb-3">Welcome, <?php 
							print_r($usr->getUser()->getUsername());?></h3>
		...
		<footer class="app-footer">
			<div class="container text-center py-3">
				...
				<small class="copyright">Designed with <span class="sr-only">love</span><i class="fas fa-heart"
						...
						target="_blank">Dinesh Kumar</a> </small>

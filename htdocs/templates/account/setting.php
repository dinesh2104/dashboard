<div class="app-wrapper">
  ...
  <circle cx="8" cy="4.5" r="1"/>
									...
									<div class="mb-3">
									    ...
									    <input type="text" class="form-control" id="setting-input-2" value="Admin" required>
									</div>
								    <div class="mb-3">
	    ...
	    <footer class="app-footer">
            ...
            <small class="copyright">Designed with <span class="sr-only">love</span><i class="fas fa-heart" style="color: #fb866a;"></i> by <a class="app-link" href="http://themes.3rdwavemedia.com" target="_blank">Dinesh Kumar</a></small>

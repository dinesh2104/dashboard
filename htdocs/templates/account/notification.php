  ...
  <div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
      ...
      <div class="app-card app-card-notification shadow-sm mb-4">
        ...
        <div class="app-card-body p-4">
          <div class="notification-content">
            ...
            ultrices dolor, ac maximus ligula. Donec ex orci, mollis ac purus
            vel, tempor pulvinar justo. Praesent nibh massa, posuere non mollis
            vel, molestie non mauris. Aenean consequat facilisis orci, sed
            sagittis mauris interdum at.
          </div>
        </div>
        <!--//app-card-body-->
      ...
      <div class="text-center mt-4">
        <a class="btn btn-secondary" href="#">Load more notifications</a>
      </div>
    </div>
    <!--//container-fluid-->
  </div>
